...
require_once __DIR__ . '/lib/BurnService2.php';

try {
    // Load environment variables
    $rpcUrl = $_ENV['SOLANA_RPC_URL'];
    $tatumApiKey = $_ENV['TATUM_API_KEY']; // Load Tatum API Key
    ...
    $burnService = new BurnService2($tatumApiKey, $burnTransactions);
    ...
    switch ($endpoint) {
        case 'total-burned':
            echo json_encode(['totalBurned' => $burnedTokens['totalBurned'] ?? 0], JSON_PRETTY_PRINT);
            break;
